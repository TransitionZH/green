...
mod {
    web_layout {
        BackendLayouts {
            default {
                title = LLL:EXT:theme_default/Resources/Private/Language/Backend.xlf:backend_layout.default
                config {
                    backend_layout {
                        colCount = 6
                        rowCount = 3
                ...
                icon = EXT:theme_default/Resources/Public/Images/BackendLayouts/default.gif
            }
        }
    }
}