    ...
    web_layout {
        BackendLayouts {
            default_2_columns_offset_right {
                title = LLL:EXT:theme_default/Resources/Private/Language/Backend.xlf:backend_layout.default_2_columns_offset_right
                config {
                    backend_layout {
                        colCount = 6
                        rowCount = 2
                ...
                icon = EXT:theme_default/Resources/Public/Images/BackendLayouts/default_2_columns_offset_right.gif
            }
        }
    }
}