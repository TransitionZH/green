...
mod {
    web_layout {
        BackendLayouts {
            default_3_columns {
                title = LLL:EXT:theme_default/Resources/Private/Language/Backend.xlf:backend_layout.default_3_columns
                config {
                    backend_layout {
                        colCount = 6
                        rowCount = 2
                ...
                icon = EXT:theme_default/Resources/Public/Images/BackendLayouts/default_3_columns.gif
            }
        }
    }
}