...
RTE.classes {
    text-left {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.text-left
    }
    text-center {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.text-center
    }
    text-right {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.text-right
    }
    text-justify {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.text-justify
    }
    lead {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.lead
    }
    active {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.active
    }
    danger {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.danger
    }
    info {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.info
    }
    success {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.success
    }
    warning {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.warning
    }
    visible-lg {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.visible-lg
    }
    visible-md {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.visible-md
    }
    visible-print {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.visible-print
    }
    visible-sm {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.visible-sm
    }
    visible-xs {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.visible-xs
    }
    table-striped {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.table-striped
    }
    table-bordered {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.table-bordered
    }
    table-hover {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.table-hover
    }
    table-condensed {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.table-condensed
    }
    list-unstyled {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.list-unstyled
    }
    list-inline {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.list-inline
    }
    btn {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn
    }
    btn-default {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-default
    }
    btn-primary {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-primary
    }
    btn-success {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-success
    }
    btn-warning {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-warning
    }
    btn-danger {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-danger
    }
    btn-link {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-link
    }
    btn-block {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.btn-block
    }
    link-arrow {
        name = LLL:EXT:theme_default/Resources/Private/Language/locallang_rte.xlf:class.link-arrow
    }
}
...
RTE.default {
    ...
    contentCSS = typo3conf/ext/theme_default/Resources/Public/Css/RTE/rte.css
...
RTE.default.buttons {
    ...
    textstyle.tags.a {
        allowedClasses (
            ...
            btn-danger, btn-link, btn-block, link-arrow
        )
    }
...
RTE.default.proc.entryHTMLparser_db {
    ...
    tags {
        ...
        a.fixAttrib.class.list      = , btn, btn-default, btn-primary, btn-success, btn-warning, btn-danger, btn-link, btn-block, link-arrow
