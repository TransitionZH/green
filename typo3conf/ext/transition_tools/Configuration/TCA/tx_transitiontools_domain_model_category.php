...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'uuid,source_id,title,name,is_top_category,image,css,parent_category,related_categories,source,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, uuid, source_id, title, name, is_top_category, image, css, parent_category, related_categories, source',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, uuid, source_id, title, name, is_top_category, image, css, parent_category, related_categories, source, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'source_id' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:transition_tools/Resources/Private/Language/locallang_db.xlf:tx_transitiontools_domain_model_category.source_id',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
...
//		),
		'parent_category' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:transition_tools/Resources/Private/Language/locallang_db.xlf:tx_transitiontools_domain_model_category.parent_category',
			'config' => array(
				'type' => 'select',
				'renderType' => 'selectSingle',
                'items' => array(
