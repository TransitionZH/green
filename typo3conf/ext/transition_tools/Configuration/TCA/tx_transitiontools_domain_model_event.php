...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'uuid,name,description,contact,weblink,venues,dates,categories,related_events,source,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, uuid, name, description, contact, weblink, venues, dates, categories, related_events, source',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, uuid, name, description, contact, weblink, venues, dates, categories, related_events, source, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
