...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'title,first_name,last_name,address1,address2,company,zip,city,country,mail,phone_fix,phone_mobile,description,comment,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, first_name, last_name, address1, address2, company, zip, city, country, mail, phone_fix, phone_mobile, description, comment',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title, first_name, last_name, address1, address2, company, zip, city, country, mail, phone_fix, phone_mobile, description, comment, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
