...
/* set map view to zürich */
 ...
 var marker = L.marker([47.38, 8.60], {icon: L.AwesomeMarkers.icon({icon: 'coffee',markerColor: 'red'})}).addTo(map);
 var marker = L.marker([47.38, 8.70], {icon: L.AwesomeMarkers.icon({icon: 'coffee',markerColor: 'blue'})}).addTo(map);
